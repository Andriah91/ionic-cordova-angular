 ...
 * and `confirm()` functions that clients are used to, in addition to allowing popups with completely
 ...
 * to the side familiar to clients of each platform. However, in cases where buttons should
 ...
 * Spinners enables you to give your clients feedback that the app is
