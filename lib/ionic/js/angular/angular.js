...
var inputType = {
  ...
  'text': textInputType,
     ...
     * modern browsers do not yet support this input type, it is important to provide cues to clients on the
...
function baseInputType(scope, element, attr, ctrl, $sniffer, $browser) {
  ...
  // In composition mode, clients are still inputing intermediate text buffer,
 ...
 *   return $http.get('/api/clients/' + value).
